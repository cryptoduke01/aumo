...
export const vaultAbi = parseAbi([
  ...
  "function maxEpochLoss() view returns (uint256)",
  "function lossEpochLength() view returns (uint256)",
  "function maxEpochDeploy() view returns (uint256)",
  "function deployEpochLength() view returns (uint256)",
