---
title: Stocks Are Coming To Aumo
status: pre-launch
date: 2026-09-14
...
- Your position tracks the stock's price against a live market feed.
- It respects market hours. When the market closes, entries and exits pause and the position simply holds, the same way the real stock stops trading. No pricing into a shut market.
- Redeem back to stablecoin whenever the market is open.
...
The contracts, the agent that executes the trades, the market-hours logic, and the pricing are done and tested. What is left is the onchain plumbing: routing and liquidity. When that lands, Stocks opens.

Follow @aumofinance and we will tell you the day it goes live.
